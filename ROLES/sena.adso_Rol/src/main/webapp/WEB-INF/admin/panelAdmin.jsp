            ...
            <div class="col-md-4">
                <div class="card shadow h-100 border-0 rounded-4">
                    <div class="card-body text-center p-4">
                        ...
                        <!-- Ir al LibroServlet con acción agregar -->
                        <a href="${pageContext.request.contextPath}/bibliotecario/libros/agregar" class="btn btn-primary mb-2">
                            <i class="bi bi-plus-circle me-1"></i> Agregar Libro
                        </a><br>
                        <!-- Ir al LibroServlet con acción listar -->
                        <a href="${pageContext.request.contextPath}/bibliotecario/libros/listar" class="btn btn-outline-primary">
            ...
            <div class="col-md-4">
                <div class="card shadow h-100 border-0 rounded-4">
                    <div class="card-body text-center p-4">
                        ...
                        <a href="${pageContext.request.contextPath}/admin/usuarios/listar" class="btn btn-warning text-dark mb-2">
                            <i class="bi bi-person-plus-fill me-1"></i> Registrar Usuario
                        </a><br>
                        <a href="${pageContext.request.contextPath}/admin/usuarios/listar" class="btn btn-outline-warning text-dark">
