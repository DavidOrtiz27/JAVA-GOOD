...
<body>
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <c:if test="${paso == 1}">
                                <form action="${pageContext.request.contextPath}/recuperar-password" method="post" class="needs-validation" novalidate>
                            ...
                            <c:if test="${paso == 2}">
                                <form action="${pageContext.request.contextPath}/recuperar-password" method="post" class="needs-validation" novalidate>
                                    ...
                                    <div class="d-grid gap-2">
                                        <button type="submit" class="btn btn-primary">
                                            <i class="bi bi-arrow-right me-2"></i>Verificar Código
                                        </button>
                                        <button type="button" class="btn btn-outline-primary" onclick="reenviarCodigo()">
    ...
    <script>
        ...
        function reenviarCodigo() {
            fetch('${pageContext.request.contextPath}/recuperar-password?accion=reenviar', {
                method: 'POST'
            })
            .then(response => response.json())
            .then(data => {
                if (data.success) {
                    alert('Se ha reenviado el código de verificación a su correo electrónico.');
                } else {
        ...
        (function () {
            ...
            Array.from(forms).forEach(form => {
                form.addEventListener('submit', event => {
                    ...
                    // Validar que las contraseñas coincidan (solo en el paso 3)
                    if (form.querySelector('input[name="paso"]').value === '3') {
