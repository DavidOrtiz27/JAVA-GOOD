            ...
            <div class="col-md-4">
                <div class="card shadow h-100 border-0 rounded-4">
                    <div class="card-body text-center p-4">
                        ...
                        <a href="${pageContext.request.contextPath}/administracion/libros/agregar.jsp" class="btn btn-primary mb-2">
                            <i class="bi bi-plus-circle me-1"></i> Agregar Libro
                        </a><br>
                        <a href="${pageContext.request.contextPath}/administracion/libros/listar.jsp" class="btn btn-outline-primary">
            ...
            <div class="col-md-4">
                <div class="card shadow h-100 border-0 rounded-4">
                    <div class="card-body text-center p-4">
                        ...
                        <a href="${pageContext.request.contextPath}/private/prestamos/nuevo.jsp" class="btn btn-success mb-2">
                            <i class="bi bi-plus-circle me-1"></i> Nuevo Préstamo
                        </a><br>
                        <a href="${pageContext.request.contextPath}/private/prestamos/listar.jsp" class="btn btn-outline-success">
